...
$sql = "INSERT INTO class_db(id, classname, capacity, indate)VALUES(NULL, :classname, :capacity, sysdate())";
$stmt = $pdo->prepare($sql);
$stmt->bindValue(':classname', $classname, PDO::PARAM_STR);  //Integer（数値の場合 PDO::PARAM_INT)
$stmt->bindValue(':capacity', $capacity, PDO::PARAM_INT);  //Integer（数値の場合 PDO::PARAM_INT)
